...
public class Ex09_Output {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 GUI > Graphic User Interface > 화면 기반 입출력
...
//		System.out.println(true);
		...
		System.out.printf("[%d]\n",num);
		System.out.printf("[%10d]\n",num);//10칸을 확보하고, 그안에서 데이터를 출력  [       123]
		
		System.out.printf("[%-10d]\n",num);  //[123       ]
		System.out.printf("[%3d]\n",12345);  //[12345] 아무일 안일어남
		System.out.println();
		...
		double num2 = 3.14;   //3.15와 같이 반올림이 될 수도 있다는걸 알아두기
