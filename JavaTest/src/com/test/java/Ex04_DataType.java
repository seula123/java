...
public class Ex04_DataType {
	...
	public static void main(String[] args) {
		...
		System.out.println(100); //점수 100 >100 (100==상수)
		
		byte score;
		score=100;
		System.out.println(score); //100 (score==변수)
		...
		System.out.println(100); //국어 점수 출력 >가독성이 낮아서 안씀 >의미(x)
		...
		//- 2개 이상 단어로 만든 합성어 일 때 > 각 단어의 첫문자를 대문자
		...
		//3. 캐멀 표기법
		//- 식별자 단어의 첫문자를 '소'문자 표기 + 나머지 문자는 소문자로 표기
		//- 2개 이상 단어로 만든 합성어 일 때 > 각 단어의 첫문자를 대문자
		//- 사용) 변수명,메소드명
		byte mathscore;
