...
public class Ex69_LinkedList {
	...
	private static void m2() {
		...
		long begin = 0, end = 0;
				...
				System.out.printf("Array 작업시간: %dms\n",end-begin);
				...
				System.out.println("[중간에 데이터 추가하기, Append]");
				...
				for(int i=list1.size()-1; i>=0; i--) {
						list1.remove(i); //끝에서 시작으로 거꾸로 삭제
				}
				...
				for(int i=list2.size()-1; i>=0; i--) {
					list2.remove(i); //끝에서 시작으로 거꾸로 삭제
			}
	...
	private static void m1() {
		...
		//- List 구현 사용법이 아주 유사하다
		//- 내부 구조가 다르고 사용 용도가 다르다
		
		//LinkedList 종류
		//1.LinkedList 일방 통행
		//2.DoubleLinkedList 양방향 통행
