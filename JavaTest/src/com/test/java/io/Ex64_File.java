...
public class Ex64_File {
	...
	public static void main(String[] args) {
		...
		/*
		  1. 파일/디렉토리 조작
		  	- 윈도우 탐색기로 하는 모든행동 > 자바로 구현
		  	- 파일은 정보확인, 새로 만들기, 이름 바꾸기, 이동하기, 삭제하기 등
		  	- 폴더는 정보확인, 새로 만들기, 이름 바꾸기, 이동하기, 삭제하기 등
...
//									,f.isDirectory()? "폴더":"파일");
	...
	private static void m7() {
		...
		if (!dir.exists()) {
			...
			System.out.println(dir.mkdirs()); //연관된 폴더 모두 함께 만들어준다.
	...
	private static void m6() {
		...
		if(file.exists()) {
			...
			//파일 이동 > 휴지통(o)
			//파일 삭제 > 휴지통(x)
			System.out.println(file.delete());  //복구 안되니까 조심!
	...
	private static void m1() {
		...
		if (file.exists()) {
			...
			System.out.println(file.lastModified()); //수정한 날짜 1691379567680
