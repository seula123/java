...
public class Ex16_Operator {
	...
	public static void main(String[] args) {
		 ...
		 */
			...
			/*
			Scanner scan = new Scanner(System.in); //ctrl +Shift + O  import java.util.Scanner;이거 만들기
			...
			*/
			...
			/*
			 비교연산자할때 모든 값형은 안전하지만 문자열(참조형)의 비교는 주의해야한다
			 */
			...
			System.out.println(s1 == s4); //false "홍"길동" == "홍길동" 인데 다르다고 나온다
			
			/*  ***** 문자열의 비교는 ==, != 연산자를 사용하면 절대절대절대 안된다
