...
//		The literal 3000000000 of type int is out of range 
		...
		//1.변수
		//2.상수
		// a. 이름이 있는 상수 >final 변수를 붙이면 값을 고칠 수 없음>
		//                 변수명>**대문자로만 작성 ex)KOR >Constant
		...
		//** 정수형 상수가 int 일까?
		//- 운영체제 + CPU
		//-운영 체제가 한 번 처리하는 데이터의 양이 int 자료형이 된다.
		
		//운영 체제
		//-8bit 운영체제 int > 1byte
		//-16bit 운영체제 int > 2byte
		//-32bit 운영체제 int > 4byte
		//-64bit 운영체제 int > 4byte
		...
		System.out.println(f1); //1.2345679E29(029)
...
//		c1 = '홍길동';
		...
		System.out.println(t3); //문자열 연산자 (O) concat , 산술연산자(X)
